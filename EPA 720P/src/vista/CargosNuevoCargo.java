 ...
 * @author Leonel
 */
public class CargosNuevoCargo extends javax.swing.JInternalFrame {
    CtrlCargo ctrlCargo = new CtrlCargo();
    Cargo cargo = new Cargo();
    /**
     * Creates new form NuevoCargo
     */
    public CargosNuevoCargo() {
        initComponents();
    ...
    public void crearCargo()
    {
        if(validar() == true)
        {
            ...
            if(cargo!=null)
            {
                ...
                dispose();
                PersonalRegistroDePersonal.cargarCbxCargo();
                PersonalRegistroDePersonal.cbxCargo.setSelectedItem(txtCargo.getText().toUpperCase());
            }
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtCargo, javax.swing.GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(159, 159, 159)
