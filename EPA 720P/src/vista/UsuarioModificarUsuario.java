 ...
 * @author Leonel
 */
public class UsuarioModificarUsuario extends javax.swing.JInternalFrame {
     ...
     */
    public UsuarioModificarUsuario() {
        initComponents();
    }
    ...
    public Boolean validar()
    {
        ...
        txtNuevoUsuario.setBorder(new JTextField().getBorder());
        ...
        if(txtUsuario.getText().equals(""))
        {
            ...
            if(txtNuevoUsuario.getText().equals("") && mostrarMsj == false)
            {
                JOptionPane.showMessageDialog(null, "Debe ingresar  Nuevo Usuario");
                txtNuevoUsuario.setBorder(new LineBorder(Color.RED, 2));
    ...
    public void modificarUsuario()
    {
        ...
        {
            usuario = new Usuario();
            usuario = ctrlUsuario.leerUsuario(txtNuevoUsuario.getText());
            if(usuario!=null)
            {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(11, 11, 11)
                        .addComponent(txtNuevoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(189, 189, 189)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(usuario!=null)
        {
            ...
            respuesta = JOptionPane.showConfirmDialog(null,"¿Desea modificar el usuario?","Modificar",confirmar);
            if (respuesta == 0 )
            {
                modificarUsuario();
            }
    ...
    private void txtNuevoUsuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNuevoUsuarioKeyTyped
        if(txtNuevoUsuario.getText().length() == 10){
            evt.consume();
        }
